...
import { TrendingUp, Clock, Code, Trophy, Target, Calendar, CheckCircle, XCircle,BarChart } from "lucide-react"
      ...
      <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-8 border border-slate-200">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <p className="text-slate-600 text-lg leading-relaxed max-w-3xl">Detailed insights into your team's performance</p>
          </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-2xl font-bold">{Math.round(averageTime / 60) || 0}m</p>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {submission.type} • {formatDate(submission.createdAt)}
                        </p>
                      </div>
                    </div>
